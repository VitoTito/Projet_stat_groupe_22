...
## 1.4 ## Supression variable num nulle 

# Data_num <- Data %>% 
#   select_if(is.numeric)
# 
# variances <- summarise_all(Data_num, var)
# vars_nulles <- names(variances)[variances == 0]


## 1.5 Potentiel regroupements ##
...
## Etape 1.6 : Regroupement variables ##
